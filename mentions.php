...
<div class="notification-list">
    <ul>
        ...
        <li><a href="mentions.php" class="multi-a" style="border-bottom: 3px solid deepskyblue;">Mentions</a></li>
    </ul>
</div>
</div>
<div class="mentions">
...
<div class="mention-msg">
    <p>
        ...
        <span class="mention-p">Use the action menu — those three little dots on a post — to untag yourself and leave a conversation.
        </span>
